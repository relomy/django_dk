...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name="player_id",
            field=models.ForeignKey(
                related_name="game_stats", to="nba.Player", on_delete=models.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="away_team",
            field=models.ForeignKey(
                related_name="away_games", to="nba.Team", on_delete=models.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="game",
            name="home_team",
            field=models.ForeignKey(
                related_name="home_games", to="nba.Team", on_delete=models.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="game",
